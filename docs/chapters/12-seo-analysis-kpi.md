...
- A. 社員の有給休暇取得率
- B. 自然検索経由のセッション数・ユーザー数　✅**（正解）**
- C. 主要キーワードの掲載順位　✅**（正解）**
- D. 自然検索経由のキーイベント（CV）数・CV率　✅**（正解）**
...
- B. 被リンクはSEOの評価にまったく関係しない
- C. 被リンクの確認にはSearch Consoleは一切使えない
- D. 被リンクは現時点での外部評価を映す指標であり、継続的な確認が必要とされる　✅**（正解）**
