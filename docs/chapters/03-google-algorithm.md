...
- A. できるだけ多くの検索結果を表示し、ユーザーに選ばせるエンジン
- B. 権威あるサイトのトップページだけを優先して返すエンジン
- C. 最も更新頻度が高いページを常に最上位に返すエンジン
- D. ユーザーの意図を正確に把握し、そのニーズに一致するものを返すエンジン　✅**（正解）**

**解説**：Larry Page氏の言葉として知られるのは「ユーザーの意図を正確に把握し、ニーズに一致するものを返す」エンジンです。表示量や更新頻度、トップページ優先などが本質ではありません。

### Q2（複数選択）

Googleの理念から整理される、SEOで取り組むべき3つのプロセスとして、正しいものをすべて選べ。

- A. 求められている情報と、その背後にある意図を把握する　✅**（正解）**
- B. 意図を過不足なく満たす、独自性・信頼性のある情報を用意する　✅**（正解）**
- C. 検索エンジンや生成AIに正しく理解・参照される状態に構造を整える　✅**（正解）**
- D. 検索エンジンを欺く手法で、短期間に順位を押し上げる
...
- B. ガイドライン違反のサイトへ個別に科される手動ペナルティ
- C. サイト運営者が申請して受けられる、順位を引き上げる公式プログラム
- D. 毎月決まった日に必ず実施される、定例のインデックス更新

**解説**：コアアップデートは検索全体の有用性・信頼性を高めるための広範な変更で、特定サイトを狙う手動ペナルティや、申請制の順位向上策ではありません。実施時期も固定ではありません。

### Q4（単一選択）

コアアップデート後に自社サイトの順位が下がった場合の考え方として、最も適切なものはどれか。

- A. 必ずガイドライン違反によるペナルティを受けたことを意味する
- B. コンテンツの品質や有用性を見直す一つの機会と捉えるのが実務上の考え方である　✅**（正解）**
- C. Googleへ再審査（再評価）を申請すれば、すぐに順位が元に戻る
- D. コアアップデートと順位変動の間には、因果関係は認められていない

**解説**：コアアップデート後の変動はペナルティではなく、品質・有用性を見直す機会と捉えます。再審査申請で即戻るものでもなく、変動と無関係でもありません。

### Q5（複数選択）

Googleが「役立つコンテンツ」を判断する際に重視するとされる観点として、正しいものをすべて選べ。

- A. 対策キーワードを本文にできる限り多く詰め込んでいるか
- B. 他のページには無い、独自の視点・データ・分析が含まれているか　✅**（正解）**
- C. 検索するユーザーにとって本当に役立つ内容になっているか　✅**（正解）**
- D. 専門知識を持つ人物・情報源によって作られているか　✅**（正解）**

**解説**：独自性・ユーザーへの有用性・専門性が重視されます。キーワードの詰め込みは『検索エンジン向け（ユーザー不在）』の典型例で、むしろ避けるべき手法です。
...
- B. サイト運営者が自分のサイトを採点する公式スコアリングツールである
- C. 外部の評価者向けにGoogleが運用する内部マニュアルで、重視する品質の基準を知る手がかりになる　✅**（正解）**
- D. 広告の審査だけに使われる、検索順位とは無関係の文書である

**解説**：検索品質評価ガイドラインは評価者向けの内部マニュアルで、順位を直接決めるアルゴリズムでも自己採点ツールでもありません。品質の考え方を知る手がかりになります。

### Q7（単一選択）

コンテンツの独自性に関するGoogleの考え方として、最も適切なものはどれか。

- A. 他サイトの内容を過不足なく要約したコンテンツが最も高く評価される
- B. 独自性より、まず文章量（文字数）の多さが評価を左右する
- C. 独自性はユーザー向けの概念で、Googleの評価には関係しない
- D. 独自の視点・データ・分析を含むコンテンツは、品質評価において重視される傾向にある　✅**（正解）**

**解説**：独自の視点・データ・分析を含むコンテンツが重視されます。他サイトの要約や単なる文字数の多さが高評価につながるわけではありません。

### Q8（複数選択）

サイトの評価要素のうち「内部要素」に含まれるものとして、正しいものをすべて選べ。

- A. コンテンツがユーザーニーズを満たしているか　✅**（正解）**
- B. 他サイトからの被リンクや、第三者による言及（サイテーション）
- C. 表示速度やモバイル対応が十分か　✅**（正解）**
- D. E-E-A-T（経験・専門性・権威性・信頼性）が担保されているか　✅**（正解）**

**解説**：内部要素は自サイトでコントロールできる範囲（コンテンツ・E-E-A-T・表示速度など）です。他サイトからの被リンクやサイテーションは外部要素に分類されます。

### Q9（単一選択）

「外部要素」の評価において重視される点として、最も適切なものはどれか。

- A. どのような文脈・信頼性を持つサイトから参照されているか、という質的な側面　✅**（正解）**
- B. 参照・言及された回数が多ければ多いほど、無条件に評価が高くなる
- C. 自作の別サイトから大量に相互リンクを送ることが最も有効な対策である
- D. 外部要素はスパムの温床のため、Googleは一切評価に用いていない

**解説**：外部要素は引用の『量』ではなく『質』（どんな文脈・信頼性のサイトからか）が重視されます。人工的な自作リンクはガイドライン違反で、外部要素が無視されるわけでもありません。
