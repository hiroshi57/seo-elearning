...
- A. サイト内の他のページと同じタイトルを使い回す
- B. 本文と乖離した、興味を引くためだけの内容にする
- C. 対策したいキーワードを、不自然にならない範囲で含める　✅**（正解）**
- D. ページの内容と一致させる　✅**（正解）**
...
- A. デザインを優先し、階層構造は無視してよい
- B. h1→h2→h3という階層構造を保って使う　✅**（正解）**
...
- B. アンカーテキストはSEOに一切関係しないため、何でもよい
...
- B. 内部リンクはクローラーの巡回には一切影響しない
- C. 内部リンクは記事の一番下にまとめて置くことだけが正解である
...
- A. サイトの表示速度を測定するGoogleのツール
- B. Googleの検索結果に「他の人はこちらも質問」として表示される、関連する質問の一覧　✅**（正解）**
