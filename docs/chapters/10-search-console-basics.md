...
- B. 有料広告の入札単価を自動調整するツール
- C. Googleが提供する、自サイトが検索結果でどう扱われているかを確認・管理できる無料ツール　✅**（正解）**
...
- A. ページで検出された構造化データの有無　✅**（正解）**
- B. 最後にGooglebotがそのページをクロールした日時　✅**（正解）**
- C. そのページがインデックスに登録されているかどうか　✅**（正解）**
- D. そのページを閲覧したユーザーの氏名
...
- D. title・descriptionの重複や記述ミスの有無　✅**（正解）**
...
- B. 従業員の人数が十分かどうか
- C. SNSのフォロワー数が増えているかどうか
- D. robots.txtで重要ページが誤ってブロックされていないか、404・500エラーが多発していないか　✅**（正解）**
