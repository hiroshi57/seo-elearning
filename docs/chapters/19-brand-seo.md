...
- A. 「SEO とは」のような一般的な情報を調べる検索
- B. 企業名やブランド名、商品名など固有名詞で検索されること　✅**（正解）**
- C. 検索エンジンが自動的に生成する検索キーワード
- D. 広告経由でのみ発生する検索

**解説**：指名検索とは、企業名やブランド名、商品名など特定の固有名詞で検索されることを指します。
...
**解説**：被リンクはa要素による明示的な引用であるため、暗示的な引用であるサイテーションよりも検索エンジンが認識・評価しやすいと考えられています。
...
- A. リンクが張られてからの経過時間を表し、新しいリンクを継続的に獲得しているページが高く評価されると考えられている　✅**（正解）**
- B. リンクの文字色を表す指標である
- C. リンク先ページの表示速度を表す指標である
...
- A. 他サイトからのリンクを呼び寄せるための、企画性の高いコンテンツ　✅**（正解）**
- B. リンク切れを検出するためのツール
- C. 自社サイト内のリンク構造を分析する手法
- D. リンクを購入するための取引仲介サービス
...
- A. サイテーションと被リンクは全く同じものである
- B. サイテーションはクリック可能なリンクがなくても、名前の言及だけで成立する　✅**（正解）**
...
- B. ページごとにユニークなtitle・description・imageを設定することが望ましい　✅**（正解）**
- C. OGPを設定すると、サイトの表示速度が自動的に向上する
...
- A. SNSでの広告費用を削減すること
- B. アカウント運営者の行動指針を示し、ユーザーに対して運営方針・責任の所在を示すこと　✅**（正解）**
- C. フォロワー数を自動的に増やす仕組みを構築すること
- D. SNS上のすべてのコメントに返信することを義務付けること
