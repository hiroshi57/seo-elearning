...
- A. 全国のユーザーに向けて、地域性を排除した情報を発信する施策
- B. 特定の地域での検索結果において、自社のビジネスを上位に表示させるための施策　✅**（正解）**
...
- B. 検索結果の上部に地図とともに表示される、3件程度の周辺店舗・施設情報　✅**（正解）**
- C. 有料広告枠のみで構成される検索結果
...
- B. Google検索やGoogleマップに使われる、店舗などのビジネス情報を管理するための無料ツールである　✅**（正解）**
- C. サイトの表示速度を計測するためのツールである
- D. 個人ブログの運営者専用に提供されているツールである
...
- A. エリア名や価格、キャンペーン情報を含めた方がユーザーに親切なので推奨される
- B. 正式名称に無関係な情報（エリア名・価格・宣伝文句など）を含めるとガイドライン違反となる可能性がある　✅**（正解）**
- C. ビジネス名は空欄のままでも問題ない
...
- A. 来店したユーザーの氏名や連絡先
- B. 検索語句、プロフィール閲覧数、通話やルート検索などのユーザー行動　✅**（正解）**
- C. 競合他社の売上データ
- D. 従業員の勤怠情報
...
- B. 悪い評価も真摯に受け止めて返信することが、信頼度向上やローカル検索順位の面で有効とされている　✅**（正解）**
- C. クチコミの数や評価はローカル検索結果に一切影響しない
- D. クチコミへの返信は禁止されている
...
- A. クチコミ投稿の見返りに金銭や割引などのインセンティブを提供する　✅**（正解）**
- B. ビジネス側や関係者が、一般ユーザーを装って自作自演のクチコミを投稿する　✅**（正解）**
- C. 会計時に「ご感想をGoogleマップにお願いします」と自然に依頼する
