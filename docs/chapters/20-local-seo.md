...
- A. 検索結果に表示されない、Google内部だけの非公開情報
- B. 有料広告枠のみで構成される検索結果の一区画
- C. 検索結果の上部に地図とともに表示される、3件程度の周辺店舗・施設情報　✅**（正解）**
- D. Googleアカウントでログインしたユーザーにしか表示されない機能

**解説**：ローカルパックは地図とともに表示される3件程度の店舗・施設情報です。非公開情報でも、広告専用枠でも、ログイン限定機能でもありません。

### Q5（単一選択）

Googleビジネスプロフィールの説明として、最も適切なものはどれか。

- A. Googleマップに広告を出稿するための有料の管理ツール
- B. 店舗のWebサイトを自動生成するためのCMS
- C. 実店舗の来客数をカメラで計測するためのツール
- D. Google検索やGoogleマップで使われる、店舗などのビジネス情報を管理する無料ツール　✅**（正解）**

**解説**：Googleビジネスプロフィールは検索・マップ向けのビジネス情報を管理する無料ツールです。広告出稿ツールやCMS、来客計測ツールではありません。
