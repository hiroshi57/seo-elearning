...
- A. 検索結果に表示するページの順位を決めるプロセス
- B. 検索エンジンのロボットがWebページを発見・巡回し、内容を収集するプロセス　✅**（正解）**
...
- B. 関連性・品質・有用性など、数多くのシグナルを組み合わせて順位が決まる　✅**（正解）**
- C. ページの公開日が新しいページが常に最上位に表示される
...
- A. 両者に違いはなく、完全に同じ意味である
- B. Website queryは1つに特定されるサイトを探しており、Visit-in-Person queryは近くにある特定ジャンルの複数の店舗・施設を探している　✅**（正解）**
