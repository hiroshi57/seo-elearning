...
SEO（検索エンジン最適化）を基礎からAI検索時代の実践まで体系的に学ぶ、全20章のEラーニングコンテンツ。

## 構成

- **基礎編**（第1〜7章）: SEOの基本概念、検索エンジンの仕組み、キーワード戦略、ライティング、テクニカルSEO、E-E-A-T
- **実践編**（第8〜13章）: GA4、Search Console、KPI分析、改善実践
- **AI時代編**（第14〜20章）: AI Overview/AI Mode、LLMO、エンティティSEO、構造化データ、ブランドSEO、ローカルSEO
...
- `data/curriculum.json`: 全20章・3フェーズのカリキュラム定義
...
- [x] 全20章のコンテンツ作成・ビルド・デプロイ完了（第20章「ローカルSEO」を新規追加、第10〜13章に書籍「保守・運用」章の内容を統合）
- [x] 1. README.mdの更新
- [x] 2. 書籍原稿（10章「ローカルSEO」・11章「保守・運用」）の内容を該当章に反映
- [x] 3. 全20章を通しての最終レビュー（内容の一貫性・レベル感統一・誤字脱字）
- [x] 4. ビジュアル面の追加（第4章・第17章にフロー図パターンを実装。第10・12・13・20章にもフロー図を追加）
